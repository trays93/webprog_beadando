...
<form action="#" method="post" class="row">
    <div class="col-md-6">
        ...
        <input type="text" name="nev" id="nev" class="form-control is-valid">
    ...
    <div class="col-12">
        ...
        <input type="text" name="targy" id="targy" class="form-control">
    </div>
    <div class="col-12">
        <label for="uzenet" class="form-label">Üzenet</label>
        <textarea name="uzenet" id="uzenet" class="form-control is-invalid" rows="3" aria-describedby="hibasUzenet"></textarea>
